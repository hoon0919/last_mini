        ...
        <v-card-text style="margin-top:-10px;">
            <v-row no-gutters style="margin: 15px 0px -10px -15px;">
                <v-col style="max-width:140px;">
                    <String class="attributes-list" label="PublishingJobId" v-model="value.parameters.publishingJobId" :editMode="editMode"/>
                </v-col>
                <v-col>
...
<script>
    export default {
        ...
        data: () => ({
            editMode: true,
            value: {
                apiPath: 'publishingJobs/search/publishingJobDetails',
                parameters: {}
            },
        }),
        created() {
