    ...
    <v-container>
        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="approveAuthorDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('System')">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="rejectAuthorDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('System')">
                    <v-icon small>mdi-minus-circle-outline</v-icon>작가 거절
                </v-btn>
            ...
            <AuthorRegistrationDetails @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></AuthorRegistrationDetails>
            <AuthorRegistrationList @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></AuthorRegistrationList>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <AuthorBio offline label="Bio" v-model="selectedRow.bio" :editMode="true"/>
                            <PortfolioUrl offline label="PortfolioUrl" v-model="selectedRow.portfolioUrl" :editMode="true"/>
                            <AuthorRegistrationStatus offline label="RegistrationStatus" v-model="selectedRow.registrationStatus" :editMode="true"/>
